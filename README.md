# MPP Solar Home Assistant Add-on v2.0.8
...
### v2.0.8 - Release bump for HA
- Version bump to trigger Home Assistant update
- Metadata synchronized across add-on files
